...
export default function VolunteerDashboard() {
  ...
  const volunteerData = {
    ...
    currentMentees: [
      { id: 1, name: "Sarah M.", program: "STEM Lab", progress: 65, nextSession: "Oct 15" },
      { id: 2, name: "Maya P.", program: "Entrepreneurship", progress: 80, nextSession: "Oct 17" },
      { id: 3, name: "Lisa K.", program: "Arts Studio", progress: 45, nextSession: "Oct 20" },
    ],
    upcomingEvents: [
      { id: 1, title: "Workshop: Career Planning", date: "Oct 16, 2025", attendees: 12 },
      { id: 2, title: "Mentor Check-in Session", date: "Oct 19, 2025", attendees: 8 },
      { id: 3, title: "Community Panel Discussion", date: "Oct 25, 2025", attendees: 25 },
    ],
    stats: {
      totalMentees: 3,
      hoursVolunteered: 48,
    ...
    recentMessages: [
      { id: 1, from: "Sarah M.", message: "Thank you for the great session!", time: "2h ago", unread: true },
      { id: 2, from: "Maya P.", message: "Can we reschedule our meeting?", time: "5h ago", unread: true },
      { id: 3, from: "IGA Team", message: "New workshop opportunity available", time: "1d ago", unread: false },
    ],
    achievements: [
          ...
          <Card className="bg-gradient-to-r from-pink-500 to-rose-700 text-white p-8">
            <div className="flex items-start justify-between">
              <div className="flex-1">
                ...
                <p className="text-pink-100 mb-4">Thank you for making a difference as a {volunteerData.role}</p>
                <div className="flex items-center gap-6 text-sm">
                  <div className="flex items-center gap-2">
                    <Users className="w-4 h-4" />
                    <span>{volunteerData.stats.totalMentees} active mentees</span>
                  </div>
                  <div className="flex items-center gap-2">
                    <Clock className="w-4 h-4" />
                    <span>{volunteerData.stats.hoursVolunteered} hours volunteered</span>
                  </div>
                </div>
              </div>
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab}>
              ...
              <div className="lg:col-span-2 space-y-6">
                ...
                <div className="grid md:grid-cols-4 gap-4">
                  <Card className="p-4">
                    ...
                    <p className="text-2xl mb-1">{volunteerData.stats.totalMentees}</p>
                  ...
                  <Card className="p-4">
                    ...
                    <p className="text-2xl mb-1">{volunteerData.stats.hoursVolunteered}</p>
                  ...
                  <Card className="p-4">
                    ...
                    <p className="text-2xl mb-1">{volunteerData.stats.sessionsCompleted}</p>
                  ...
                  <Card className="p-4">
                    ...
                    <p className="text-2xl mb-1">{volunteerData.stats.impactScore}</p>
                    ...
                    {volunteerData.currentMentees.map((mentee) => (
                      <div key={mentee.id} className="border border-gray-200 rounded-lg p-4">
                        <div className="flex items-start justify-between mb-3">
                          ...
                          <Badge variant="secondary">{mentee.progress}% complete</Badge>
                        </div>
                        <div className="flex items-center justify-between">
                ...
                <Card className="p-6">
                  ...
                  <div className="space-y-3">
                    {volunteerData.recentMessages.map((message) => (
                      <div key={message.id} className={`pb-3 border-b border-gray-200 last:border-0 last:pb-0 ${message.unread ? 'bg-purple-50 -mx-3 px-3 py-2 rounded' : ''}`}>
          ...
          <TabsContent value="mentees">
            <Card className="p-6">
              ...
              <p className="text-gray-600">Detailed mentee information would be displayed here...</p>
            </Card>
          </TabsContent>
          ...
          <TabsContent value="workshops">
            <Card className="p-6">
              ...
              <p className="text-gray-600">Workshop management would be displayed here...</p>
            </Card>
          </TabsContent>
          ...
          <TabsContent value="messages">
            <Card className="p-6">
              ...
              <p className="text-gray-600">Message inbox would be displayed here...</p>
            </Card>
          </TabsContent>
        </Tabs>
      </div>
